# Latent Market Twin — Research Log

Week-by-week research history of the project, from the first dataset skeleton to the live paper-trading system. The current-state documentation lives in [README.md](README.md).
