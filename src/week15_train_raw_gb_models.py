...
def evaluate_model(model, X, y, split_name: str, dataset_name: str, horizon: int) -> dict:
...
def train_one(dataset_name: str, horizon: int):
    ...
    print("")
    print("=" * 90)
    print(f"Training raw GB | dataset={dataset_name} | horizon={horizon}m")
    ...
    for split_name, X, y in [
        ...
        result = evaluate_model(model, X, y, split_name, dataset_name, horizon)
    ...
    pred_path = f"outputs/tables/week15_raw_gb_predictions_{dataset_name}_{horizon}m.csv"
...
def main():
    ...
    metrics_path = "outputs/tables/week15_raw_gb_model_metrics.csv"
    signals_path = "outputs/tables/week15_raw_gb_portfolio_signal.csv"
    report_path = "outputs/reports/week15_raw_gb_model_summary.txt"

    metrics_df.to_csv(metrics_path, index=False)
    signals_df.to_csv(signals_path, index=False)

    with open(report_path, "w", encoding="utf-8") as f:
        f.write("Week 15 Raw Gradient Boosting Model Summary\n")
        f.write("==========================================\n\n")
        f.write("Goal:\n")
        f.write(
            "Train raw-feature gradient boosting models on full500, highvol100, and highvol200 universes "
