...
def load_features(dataset_name: str) -> pd.DataFrame:
    path = f"data/processed/week15_{dataset_name}_modeling_dataset.parquet"
...
def load_predictions(dataset_name: str, model_type: str, horizon: int) -> pd.DataFrame:
    if model_type == "raw_gb":
        path = f"outputs/tables/week15_raw_gb_predictions_{dataset_name}_{horizon}m.csv"
    elif model_type == "ae_gb":
        path = f"outputs/tables/week15_ae_gb_predictions_{dataset_name}_{horizon}m.csv"
    else:
...
def main():
    ...
    stats_path = "outputs/tables/week15_raw_vs_ae_backtest_stats.csv"
    curves_path = "outputs/tables/week15_raw_vs_ae_backtest_curves.csv"
    holdings_path = "outputs/tables/week15_raw_vs_ae_backtest_holdings.csv"
    figure_path = "outputs/figures/week15_raw_vs_ae_backtest_equity_curves.png"
    report_path = "outputs/reports/week15_raw_vs_ae_backtest_summary.txt"
