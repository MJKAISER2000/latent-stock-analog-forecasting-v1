...
def train_one(dataset_name: str, horizon: int, device: str):
    ...
    print("")
    print("=" * 90)
    print(f"Training Week 16 AE + GB | dataset={dataset_name} | horizon={horizon}m")
    ...
    pred_path = f"outputs/tables/week16_ae_gb_predictions_{dataset_name}_{horizon}m.csv"
...
def main():
    ...
    metrics_path = "outputs/tables/week16_ae_gb_model_metrics.csv"
    signals_path = "outputs/tables/week16_ae_gb_portfolio_signal.csv"
    report_path = "outputs/reports/week16_ae_gb_model_summary.txt"

    metrics_df.to_csv(metrics_path, index=False)
    signals_df.to_csv(signals_path, index=False)

    with open(report_path, "w", encoding="utf-8") as f:
        f.write("Week 16 Autoencoder + Gradient Boosting Model Summary\n")
        f.write("====================================================\n\n")
        f.write("Goal:\n")
        f.write(
            "Train autoencoder latent-feature gradient boosting models on large balanced volatility universes "
