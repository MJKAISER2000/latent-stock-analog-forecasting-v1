...
def categorize_feature(feature_name: str) -> str:
    ...
    if name.startswith("market_pca_"):
        return "market_pca_latent"
...
def main():
    ...
    print("Training PCA latent ranker for feature importance...")
    ...
    latent_importance = importance[
        importance["feature_category"] == "market_pca_latent"
    ].copy()
    ...
    importance_path = "outputs/tables/week19_pca_latent_feature_importance.csv"
    category_path = "outputs/tables/week19_pca_latent_feature_importance_by_category.csv"
    latent_path = "outputs/tables/week19_pca_latent_feature_importance_latent_only.csv"
    report_path = "outputs/reports/week19_pca_latent_feature_importance_summary.txt"
    model_path = "models/week19_pca_latent_feature_importance_lgbm_ranker.txt"

    importance.to_csv(importance_path, index=False)
    category_summary.to_csv(category_path, index=False)
    latent_importance.to_csv(latent_path, index=False)

    booster.save_model(model_path)

    with open(report_path, "w", encoding="utf-8") as f:
        f.write("Week 19 PCA Latent Ranker Feature Importance Summary\n")
        f.write("===================================================\n\n")

        f.write("Goal:\n")
        f.write("Check whether the LightGBM ranker is actually using the market PCA latent features.\n\n")
        ...
        f.write("Top 50 features by gain:\n")
        f.write(
            importance[
                [
                    "feature",
        ...
        f.write("Market PCA latent feature importance:\n")
        f.write(
            latent_importance[
                [
                    "feature",
    ...
    print("")
    print("MARKET PCA LATENT FEATURE IMPORTANCE")
    print(
        latent_importance[
            [
                "feature",
