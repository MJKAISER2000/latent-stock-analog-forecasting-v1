...
BASE_STRATEGY_RETURN_COL = "top10_return"
...
def main():
    ...
    stats_path = "outputs/tables/week18_top10_tech_regime_filter_stats.csv"
    curves_path = "outputs/tables/week18_top10_tech_regime_filter_curves.csv"
    regime_path = "outputs/tables/week18_top10_tech_regime_features.csv"
    report_path = "outputs/reports/week18_top10_tech_regime_filter_summary.txt"
    ...
    with open(report_path, "w", encoding="utf-8") as f:
        f.write("Week 18 Top10 Tech Regime Filter Summary\n")
        f.write("=======================================\n\n")
        f.write("Goal:\n")
        f.write("Apply tech-regime filters to the more diversified top10 ranker portfolio.\n\n")
        f.write("Results by return/drawdown:\n")
